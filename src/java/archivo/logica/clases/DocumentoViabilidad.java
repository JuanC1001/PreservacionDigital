...
public class DocumentoViabilidad {
    ...
    public DocumentoViabilidad() {
    }

    public DocumentoViabilidad(int codigo, UsuarioRol codigo_usuario_rol, String titulo_ducumento, String detalles, String titulo, String path, String tipo, String keywords, Date fecha_registro) {
        this.codigo = codigo;
