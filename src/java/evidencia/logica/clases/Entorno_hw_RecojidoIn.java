 ...
 * @author ruben
 */
public class Entorno_hw_RecojidoIn {
    private int codigo;
    ...
    public Entorno_hw_RecojidoIn() {
    }

    public Entorno_hw_RecojidoIn(int codigo, UsuarioRol codigo_usuario_rol, String tipo, String marca, String modelo, String foto, String observacion, Timestamp fecharegistro_hwreco) {
        this.codigo = codigo;
