 ...
 * @author RUBEN
 */
public class Entorno_sw_Recojido {
    ...
    public Entorno_sw_Recojido() {
    }

    public Entorno_sw_Recojido(int codigo, UsuarioRol codigo_usuario_rol, String nombre, String ver_sion, String sw_base, String sw_aplicacion, String observacion, Timestamp fecharegistro_entornoswreco) {
        this.codigo = codigo;
