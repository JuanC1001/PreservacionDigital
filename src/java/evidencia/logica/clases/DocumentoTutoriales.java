 ...
 * @author ruben
 */
public class DocumentoTutoriales {
    ...
    public DocumentoTutoriales() {
    }

    public DocumentoTutoriales(int codigo, UsuarioRol codigo_usuario_rol, String titulo_ducumento, String detalles, String titulo, String path, String tipo, String keywords, Date fecha_registro) {
        this.codigo = codigo;
